...
class AdminEdit:
    ...
    def __init__(self, admin_id):
        ...
        self.panel.title("Edit Admin Profile")
        ...
        self.canvas.create_text(self.xp(50), self.yp(7), text="Admin Profile Edit" ,fill="#3B496F", font=('Candara', self.yp(8), "bold"), anchor='center')

        self.ad_id=admin_id
        result=main.get_admin(admin_id)
    ...
    def submit(self):
        ...
        data=(self.name.get(), self.email.get(),self.password.get(), self.ad_id)
        main.edit_admin(data)
        self.panel.destroy()
